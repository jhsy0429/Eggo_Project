...
public class ElectFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.fragment_elect, container, false);
...
//        yAxis.setGranularity((float) RANGE[1][range]);
        ...
        dataSet.setColor(Color.rgb(178, 223, 138));
        dataSet.setCircleColor(Color.rgb(178, 223, 138));
